...
const NewCollection = () => {
  return (
    <div className="flex flex-col md:flex-row gap-3 pb-10 flex-w justify-center mb-20 max-w-7xl px-5 mx-auto">
      <div
      ...
      <div
        className="md:flex flex md:w-6/12 gap-3 flex-col"
        data-aos="flip-right"
        data-aos-duration="1000"
      >
        <div className="md:flex items-center rounded-2xl hover:shadow-lg p-5 justify-center border">
          ...
          <img
            className="md:w-6/12 mt-5 rounded-xl"
        ...
        <div className="md:flex items-center rounded-2xl hover:shadow-lg border bg-red-100 justify-center p-5">
          ...
          <img className="lg:w-3/12" src={newShoes} alt="" />
        </div>
      </div>
    </div>
  );
